...
sapply(c('rgdal', 'raster', 'data.table', 'magrittr', 'sp', 'rgeos', 'raster', 'foreach', 'ncdf4', 'gdalUtilities',library("rnaturalearthdata"),"rnaturalearth", 'windR', 'geosphere', 'ggplot2'),
       function(x) suppressPackageStartupMessages(require(x , character.only = TRUE, quietly = TRUE) ) )
cosd <-function(x) cos(x*pi/180) #en degré 
sind <-function(x) sin(x*pi/180) #en radian
###GET DATA###
